...
def main():
    ds_nhan_vien = []
    nhap_list_danh_sach_nhan_vien(ds_nhan_vien)
    in_list_danh_sach_nhan_vien(ds_nhan_vien)
    sap_xep_danh_sach(ds_nhan_vien)
    luu_tap_tinnhiphan(ds_nhan_vien, 'NhanVien.txt')
    doc_tap_tin_nhi_phan('NhanVien.txt')
